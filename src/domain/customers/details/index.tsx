...
const CustomerDetail = () => {
  ...
  const actions: ActionType[] = [
    ...
    {
      label: "Eliminar (aún no implementado)",
  ...
  return (
    <div>
      <Breadcrumb
        currentPage={"Detalles del cliente"}
        previousBreadcrumb={"Clientes"}
      ...
      <BodyCard
        ...
        subtitle="Una descripción general de los pedidos del cliente"
      >
        {isLoading || !customer ? (
