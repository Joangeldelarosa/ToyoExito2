        ...
        <RadixCollapsible.Content className="w-full">
          {hasPrev && (
            <div className="py-2 pl-6 flex">
              <button
                onClick={handlePrev}
                className="font-semibold hover:text-emerald-60 text-grey-90"
              >
                Back
              </button>
            </div>
                ...
                >
                  <div
                    className={`w-5 h-5 flex justify-center text-grey-0 border-grey-30 border mr-2 rounded-base ${
                      checked[value] === true && "bg-emerald-60"
                    }`}
                  >
                    <span className="self-center">
        ...
        >
          <div
            className={clsx(
              ...
              {
                "border-2 border-emerald-60": item === selectedItem,
                "border border-grey-30 ": item !== selectedItem,
              }
            )}
          >
            {item === selectedItem && (
              <div className="rounded-full w-2 h-2 bg-emerald-60" />
            )}
          </div>
          {item}
        </div>
