  ...
  return (
    <div
      ...
      className={cx(
        ...
        clsx(
          "flex p-0 overflow-hidden rounded-rounded border border-gray-20 bg-grey-5 focus-within:shadow-cta transition-colors focus-within:border-emerald-60 box-border pl-small",
          {
            "h-xlarge": size === "sm",
            "h-10": size === "md" || !size,
          },
